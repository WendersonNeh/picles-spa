...
import { getPetByld } from '../../services/pets/getPetByld'
    ...
    <Grid>
      <div className={styles.container}>
        ...
        <main className={styles.content}>
          {isLoading && (
            <div className={styles.skeleton}><Skeleton circle={true} width={200} height={200} />
            <Skeleton width={180} height={24} style={{ margin: 16 }} /> </div>
            ...
            <>
              ...
              {PetIsError  && (
                <>
                  ...
                  <Link to="{/pets}">Voltyar para a listagem</Link >
              </>
              )}
              {!PetIsError && (
                <>        
                  ...
                  {!shelterIsError && (
                      <a
                      href={`https://wa.me/${shelterData?.shelterWhatsApp}?text=Olá, gostaria de falar sobre ${petData}`}
                      target="_blank"
                      >
